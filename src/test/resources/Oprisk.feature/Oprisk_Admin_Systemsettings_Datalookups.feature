...
Scenario: To Test Admin menu in Assert class under Asserts option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Authoritative Sources type under Authoritative Sources in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Lines of business under common option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Control catagory under Control option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Control performance definiton under Control signoff option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Indicator score colours under Indicator option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Action priority under Issue and Action option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Cause under Incident and loss option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Organisation Unit Type under Organisation Unit option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Risk Catagory under Risk option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Risk Assessment Status under Risk Assessment option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
...
Scenario: To Test Admin menu in Survey Answer Groups under Surveys option in Data looks ups in System settings
Given To open the OneSumX application
When To click the Admin menu option in home page
When To mouse hover to System settings Option
When To click Data looks ups in System settings
